...
| V2 Phase 2 (Feature Enhancements) | 5 |
| V3 Phase 3 (Commercial Readiness) | 3 |
| V1 Stories Created | 51 |
| V2 Stories Created | 32 |
| V2 Story Points | 122 |
...
| [EP0009](./EP0009-sms-strategy-overhaul.md) | SMS Strategy Overhaul | V2-P2 | Done | 8 |
| [EP0010](./EP0010-programs-sections-overhaul.md) | Programs & Sections Overhaul | V2-P2 | Done | 8 |
| [EP0011](./EP0011-multi-camera-scanning.md) | Multi-Camera Scanning | V2-P2 | Done | 6 |
...
|------|-------------|----------|---------|
| EP0009 | SMS Strategy Overhaul — No-Scan Alert, per-broadcast gateway, personal SMS | Amy, Gary | WebApp |
| EP0010 | Programs & Sections Overhaul — Self-referencing hierarchy, mandatory section-program, Non-Graded | Amy, Tina | WebApp |
| EP0011 | Multi-Camera Scanning — 1-8 cameras, adaptive throttle, per-camera scan type | Gary, Tony | ScannerApp |
